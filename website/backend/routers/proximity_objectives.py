...
@handle_router_errors("Carrier events error")
...
@handle_router_errors("Carrier kills error")
...
@handle_router_errors("carrier-returns error")
...
@handle_router_errors("vehicle-progress error")
...
@handle_router_errors("escort-credits error")
...
@handle_router_errors("construction-events error")
...
@handle_router_errors("objective-runs error")
...
@handle_router_errors("objective-focus error")
