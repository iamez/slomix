...
from website.backend.routers import auth, predictions, greatshot, greatshot_topshots, uploads, availability, planning, proximity_router, diagnostics_router, sessions_router, players_router, records_router, skill_router, storytelling_router
