...
### Team Detection (2 modules)

| Module | Purpose |
|--------|---------|
| `team_manager.py` | Team detection + real-time tracking (single source of truth — `advanced_team_detector.py` was removed as unused in PR #254) |
