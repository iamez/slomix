...
def get_admin_commands():
    ...
    async def health_command(ctx):
        ...
        try:
            ...
            await ctx.send(
                f"❌ Error getting health status: {sanitize_error_message(e)}")
    ...
    async def backup_command(ctx):
        ...
        try:
            ...
            await ctx.send(f"❌ Backup failed: {sanitize_error_message(e)}")
    ...
    async def vacuum_command(ctx):
        ...
        try:
            ...
            await ctx.send(f"❌ Optimization failed: {sanitize_error_message(e)}")
    ...
    async def errors_command(ctx):
        ...
        try:
            ...
            await ctx.send(
                f"❌ Error getting error stats: {sanitize_error_message(e)}")
