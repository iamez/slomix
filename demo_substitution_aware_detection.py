...
def demo_with_substitutions(session_date: str, db_path: str = "bot/etlegacy_production.db"):
    """
    ...
    sub_analysis = sub_detector.analyze_session_roster_changes(db, session_date)
    ...
    result = team_detector.detect_session_teams(db, session_date)
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        print("Usage: python demo_substitution_aware_detection.py <session_date>")
