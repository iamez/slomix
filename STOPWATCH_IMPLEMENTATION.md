...
- Added `winner_team INTEGER` to sessions table
- Added `defender_team INTEGER` to sessions table
...
**Method**: `calculate_session_scores(session_date)`
...
- Calls `scorer.calculate_session_scores(session_date)`
...
3. **Season Tracking**: Track cumulative team scores across multiple sessions
...
✅ Bot displays team scores in !last_session
