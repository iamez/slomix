...
## [1.46.0](https://github.com/iamez/slomix/compare/v1.45.0...v1.46.0) (2026-09-20)


### Features

* **bot:** apply retained Lua corrections with atomic receipts ([90eae0f](https://github.com/iamez/slomix/commit/90eae0f8a69c3ecedb995dcf08b642fde0c62b41))
* **bot:** journal atomic Lua metadata corrections ([3099633](https://github.com/iamez/slomix/commit/3099633d492a600af4c39d13d2c6c6824628202b))
* **bot:** journal canonical endstats storage atomically ([21eb638](https://github.com/iamez/slomix/commit/21eb638af873186d8ebccdb3149600e34483cc2f))
* **bot:** retain Lua correction inputs before volatile dispatch ([422f056](https://github.com/iamez/slomix/commit/422f056acd338c13414c02f722199d8b7ad78ac6))
* **bot:** retain versioned Lua correction inputs durably ([64488de](https://github.com/iamez/slomix/commit/64488de118acfd34c1917eb0f5679d26932a95a9))
...
* **db:** add durable bounded Lua correction retries ([2518735](https://github.com/iamez/slomix/commit/2518735f19763a539887d61c9d9c5fe99d0ec1bf))
* **db:** add transactional initial import runtime journal ([9cbd881](https://github.com/iamez/slomix/commit/9cbd88108cc9fd45861c2051c4b3e69395ec7fc1))
* **db:** journal canonical restart status transitions ([4a7e073](https://github.com/iamez/slomix/commit/4a7e0738185e31b97ea50953a1be36c74ba431c3))
* **db:** journal transactional round timing reconciliation ([fc65585](https://github.com/iamez/slomix/commit/fc65585568280049459adab08f373af4662de11d))
* **db:** reserve exclusive runtime source generations ([1a78b71](https://github.com/iamez/slomix/commit/1a78b713d2c1128e256923e57163c21b6d61d8a4))
...
* **bot:** align watchdog disk usage with available capacity ([89a2fd3](https://github.com/iamez/slomix/commit/89a2fd388d7f138426de1df9ba6f9419557109c3))
* **bot:** allow opt-in retry of failed endstats publication ([a2b7255](https://github.com/iamez/slomix/commit/a2b725509a37328e6e4dc04217b6026ebf4f737f))
* **bot:** preserve endstats marker ownership across retry chains ([d946772](https://github.com/iamez/slomix/commit/d946772b20d99d1f4157333ffa4e919e5ec3000f))
* **bot:** reschedule bounded endstats retries after exceptions ([9ffbcd5](https://github.com/iamez/slomix/commit/9ffbcd5ed9b83ac0591a2ad8ecdf1cc2849527b0))
...
* **website:** story header Kills = real session total, not KIS subset ([#709](https://github.com/iamez/slomix/issues/709)) ([1c094b3](https://github.com/iamez/slomix/commit/1c094b303e73e34ab7a69f830747f69917dab34d))
...
* **lua:** objective live ping, default OFF (repo-only, not deployed) ([35282c9](https://github.com/iamez/slomix/commit/35282c9d43b0c1027f027ed024d15b603a8a71c7))
* **lua:** objective live ping, default OFF (repo-only, not deployed) ([dbb4fa6](https://github.com/iamez/slomix/commit/dbb4fa60db8c5acfe32862ce3b900a383a307752))
...
* **website:** add legends/units to proximity panels (workstream C, tier 2) ([#626](https://github.com/iamez/slomix/issues/626)) ([b016934](https://github.com/iamez/slomix/commit/b01693485b82850018b9e10752c30736aeae22b9))
...
* allowed_mentions guard + exact keyword-set comparison ([b38a8e7](https://github.com/iamez/slomix/commit/b38a8e75d4d6683876eedca87b9fc27d340825c5))
...
* scope keyword assertions to the executable et_Print block ([9c230d6](https://github.com/iamez/slomix/commit/9c230d6c9d2bb46d91370dcb6b4cf5c9705a4690))
...
* **website:** disambiguate movement time units + KPI hierarchy (workstream C, tier 4) ([#628](https://github.com/iamez/slomix/issues/628)) ([84f33fc](https://github.com/iamez/slomix/commit/84f33fc0b00f3e70973e101f319060076f7564ec))
...
* **website:** proximity leaderboard hierarchy + missing tooltips (workstream C, tier 3) ([#627](https://github.com/iamez/slomix/issues/627)) ([876946d](https://github.com/iamez/slomix/commit/876946db7173f32347bfb66bd3c0e27d72a4f9e1))
...
* **website:** render proximity bar charts (were 0px height) ([#625](https://github.com/iamez/slomix/issues/625)) ([215c782](https://github.com/iamez/slomix/commit/215c782670302e5ab45525d69e87f9ec532722af))
...
* **bot,website:** startup migration-drift guard (prevents silent schema drift) ([#545](https://github.com/iamez/slomix/issues/545)) ([f52ccd4](https://github.com/iamez/slomix/commit/f52ccd4fee798038ea1beabc43ee30a83afc13c4))
