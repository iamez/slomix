...
cursor.execute("""
    ...
    AND substr(session_date, 12, 2) = '00'  -- Hour is 00
    AND CAST(substr(session_date, 12, 6) AS INTEGER) <= 3000  -- Time <= 00:30:00
...
for r2_id, r2_date, r2_map, r2_round, r2_map_id in r2_midnight_sessions:
    ...
    # Extract date from session_date (format: YYYY-MM-DD-HHMMSS)
    ...
    cursor.execute("""
        ...
        AND substr(session_date, 12, 2) = '23'  -- Hour is 23
