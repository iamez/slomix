...
cursor.execute("""
    ...
    VALUES (?, ?, ?, ?)
""", (session_date, "Team A", json.dumps(list(team_a_guids)), 
...
4. **Confidence Scoring:** Rate detection quality per session
5. **Cross-Session Teams:** Track same teams across multiple sessions
