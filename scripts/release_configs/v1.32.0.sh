# Release config for v1.32.0 — Live view + Live v2 (event feed with attribution,
# roster bot filter, Tonight→Live rename, live momentum/hold, live_events.lua
# LIVEX pipeline groundwork). No new migrations vs v1.31.0 — website JS +
# parser + Lua only; full 045+ range kept for straight upgrades.
