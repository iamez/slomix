# Release config for v1.34.0 — A4 live objective attribution, C2 proximity orphan relinker, Greatshot headshot revival (G3), C4 vehicle escort distance, live idle-roster + C5 prediction cull. No new migrations vs v1.33.1.
