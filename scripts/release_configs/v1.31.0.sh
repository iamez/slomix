# Release config for v1.31.0 — FIX-ME program batch (help fix, validity flags on
# the production import path, OBJECTIVE end_reason, relinker coverage 25→29
# tables + migration 071, importer-awake orphan aging, proximity clamps,
# ET Rating shrinkage K=40, usage_report consumption loop, COMMANDS.md CI guard).
...
RELEASE_NOTES="Deploy validate-as-owner fix, combat heatmap race guard, crossfire duo names + team panel tooltips, webhook secret moved out of the repository (Lua v1.7.2 config loader)."
