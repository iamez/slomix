# Release config for v1.30.1 — deploy tooling + website fixes + webhook secret
# loader (no NEW migrations vs v1.30.0; full 045+ range kept so older
# production checkouts can still upgrade straight to this tag — see the
# v1.30.0 config for the rationale).
