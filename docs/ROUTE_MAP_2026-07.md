...
| `home` | `(root — empty hash)` | Legacy JS | website/js/app.js + website/js/home.js + website/js/leaderboard.js + website/js/live-status.js + website/js/matches.js + website/js/season-stats.js + website/js/sessions.js — populated directly from initApp() in app.js (criticalLoads + scheduleDeferredLoads), not through load() |
