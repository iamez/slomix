...
- Executed and validated (manual): `!ping`, `!stats` (linked/fuzzy/name/mention), `!compare` (chart and text fallback), `!last_round`, `!session_start`/`!session_end`, `!leaderboard`, `!season_info`, `!cache_clear`, `!check_achievements` and typo aliases.
