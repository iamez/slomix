...
### Status: ⭐ Excellent - Minor Enhancement

### Task 1.1: Add `calculate_time_dead_ratio` method

**Location:** End of the `StatsCalculator` class, before the final closing
...
**Verification:** Run Python and test:

```python
from bot.stats import StatsCalculator
assert StatsCalculator.calculate_time_dead_ratio(30, 300) == 10.0
assert StatsCalculator.calculate_time_dead_ratio(0, 300) == 0.0
assert StatsCalculator.calculate_time_dead_ratio(60, 0) == 0.0
print("calculator.py tests passed!")
```python
