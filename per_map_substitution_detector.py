...
def analyze_map_substitutions(cursor, session_date: str, map_name: str):
...
def analyze_session_substitutions(session_date: str):
    ...
    print("="*80)
    print(f"SUBSTITUTION ANALYSIS: {session_date}")
    print("="*80)
    ...
    for map_name in maps:
        analyze_map_substitutions(cursor, session_date, map_name)
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("Usage: python per_map_substitution_detector.py <session_date>")
        print("Example: python per_map_substitution_detector.py 2025-11-01")
        sys.exit(1)
    
    session_date = sys.argv[1]
    analyze_session_substitutions(session_date)
