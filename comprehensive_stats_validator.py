...
class StatsValidator:
    ...
    def analyze_october_november(self):
        ...
        for date in sorted(by_date.keys()):
            ...
            for filepath in files:
                ...
                try:
                    ...
                    # Database round_date format is: YYYY-MM-DD-HHMMSS (from filename)
                    # Extract from filename: 2025-10-27-230230-mapname-round-N.txt
                    round_date = basename[:19]  # e.g. "2025-10-27-230230"
                    ...
                    for player in parsed_data['players']:
                        self.validate_player_data(
                            cursor, round_id, basename, 
                            round_date, map_name, round_num, player
                        )
        ...
        print(f"{'='*80}")
        print(f"📊 Total sessions analyzed: {total_rounds}")
        print(f"👥 Total player records: {total_players}")
        print(f"⚠️  Total issues found: {len(self.issues)}")
        print()
        
    def validate_player_data(self, cursor, round_id, filename, 
                            round_date, map_name, round_num, player):
    ...
    def export_results(self):
        ...
        with open(raw_log_path, 'w', encoding='utf-8') as f:
            ...
            for entry in self.raw_data_log:
                ...
                f.write(f"SESSION: {entry['round_date']} - {entry['map']} R{entry['round']}\n")
    ...
    <div class="container">
        ...
        <div class="summary">
            ...
            <div class="summary-card green">
                ...
                <p class="value">{len(set(e['round_date'] for e in self.raw_data_log))}</p>
            </div>
