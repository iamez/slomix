...
class ComprehensiveRoundAnalyzer:
    ...
    def analyze_session(self, session_date: str):
        """Perform comprehensive round-by-round analysis"""
        conn = sqlite3.connect(self.db_path)
        cursor = conn.cursor()
        
        print("=" * 100)
        print(f"🔍 COMPREHENSIVE ROUND-BY-ROUND ANALYSIS: {session_date}")
        print("=" * 100)
        print()
        
        # Step 1: Get session info
        self._show_session_info(cursor, session_date)
        print()
        
        # Step 2: Get ALL rounds with ALL data
        rounds_data = self._get_all_rounds_detailed(cursor, session_date)
        print()
    ...
    def _show_session_info(self, cursor, session_date: str):
    ...
    def _get_all_rounds_detailed(self, cursor, session_date: str) -> Dict[int, Dict]:
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("Usage: python comprehensive_round_analyzer.py <session_date>")
    ...
    analyzer.analyze_session(session_date)
