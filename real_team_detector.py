...
class RealTeamDetector:
    ...
    def detect_teams(self, session_date: str) -> Dict:
        """
        ...
        print("="*80)
        print(f"REAL TEAM DETECTION: {session_date}")
        print("="*80)
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("Usage: python real_team_detector.py <session_date>")
    ...
    result = detector.detect_teams(session_date)
