...
players_data = detector._get_session_player_data(db, round_date)
...
historical = detector._analyze_historical_patterns(db, players_data, round_date)
if historical:
...
consensus = detector._analyze_multi_round_consensus(db, round_date, players_data)
if consensus:
...
cooccurrence = detector._analyze_cooccurrence(db, round_date, players_data)
if cooccurrence:
...
result = detector.detect_session_teams(db, round_date)
print()
