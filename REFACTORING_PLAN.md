...
│   ├── session_cog.py          # !last_session, !sessions, !session_start/end
...
**NOTE:** The `!last_session` command is HUGE and deserves special attention.
...
This cog handles the complex !last_session command with multiple views:
...
class SessionCog(commands.Cog):
    ...
    # ================================================================
    # MAIN COMMAND: !last_session (with subcommands)
    # ================================================================
    ...
    async def last_session(self, ctx, subcommand: str = None):
        ...
        Usage:
            ...
            !last_session rounds       - Round-by-round details
