...
def test_w5b_bounded_nested_executor_smokes_every_concrete_event_entry(geometry_index):
    ...
    assert frontier_counts == {
        ("domain_set", ()): 408,
        ("domain_set", ("dynamic_route",)): 300,
        ("domain_set", ("dynamic_route", "objective")): 226,
        ...
        ("unknown_reason", "runtime_route_source_not_w3_linked:faceangles"): 295,
        ("unknown_reason", "runtime_route_source_not_w3_linked:remove"): 132,
    ...
    assert cross_frontier_counts == {
        ("domain_set", ()): 59,
        ("domain_set", ("dynamic_route",)): 170,
        ("domain_set", ("dynamic_route", "objective")): 47,
        ...
        ("unknown_reason", "runtime_route_source_not_w3_linked:faceangles"): 36,
