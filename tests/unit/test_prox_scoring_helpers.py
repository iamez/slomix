...
def test_formula_version_pinned():
    """FORMULA_VERSION="3.0" — pin so any formula change is a deliberate bump.
    3.0 = #556 metric-validity pass (13 of 18 metrics retired from the score);
