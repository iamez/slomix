...
frame(500)               -- a poll reads the truck alive (800)
-- Goldrush-style start: the map script sets the mover up alive, then
-- breaks it within the first second (to be repaired). Nobody has escorted
-- it yet, so this is its start state, not a destruction — nothing counted.
truck.health = 0
frame(500)
truck.health = 800
frame(500)
