...
def get_db_player_stats(round_id):
    ...
    query = f"SELECT {', '.join(columns)} FROM player_comprehensive_stats WHERE round_id = ?"
...
def analyze_all_players():
    ...
    for round_id, round_date, map_name, round_num, winner_team in sessions:
        print(f"\n   Processing: {round_date} {map_name} R{round_num}")
        
        # Find corresponding stat file
        pattern = f"local_stats/{round_date}-{map_name}-round-{round_num}.txt"
        ...
        # Get DB players
        db_players = get_db_player_stats(round_id)
        ...
        analysis['rounds'].append(session_analysis)
...
<body>
    ...
    <div class="nav">
        ...
        <div class="nav-buttons">
            ...
            <button class="nav-btn" onclick="showPage('rounds')">All Sessions</button>
    ...
    <div class="presentation">
        ...
        <div class="slide">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    <div class="stat-number">{analysis['total_rounds']}</div>
...
"""
    ...
    # Add session cards
    for session in analysis['rounds']:
        ...
        html += f"""
            <div class="session-card">
                <div class="session-header">
                    ...
                    <div class="session-meta">{session['round_date']} | Winner: Team {session['winner_team']}</div>
                </div>
...
print(f"   Sessions Verified: {analysis['total_rounds']}")
