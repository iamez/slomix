...
✅ **VERIFIED** - Line 964: `SELECT player_guid, player_name, team, session_id, map_name, round_number`
...
**Fix Summary:** Team detection now uses `(session_id, map, round)` as key instead of `(map, round)`, allowing proper handling of multiple plays of the same map.
