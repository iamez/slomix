...
def get_round_rounds_detailed(conn, date):
...
def get_round_players(conn, round_date, map_name, round_num):
    ...
    """, (f"{round_date}%", map_name, round_num))
...
def analyze_session_ultra_detailed(date, db_path):
    ...
    for round_data in rounds:
        (db_id, round_date, map_name, map_id, round_num, winner_team,
        ...
        players = get_round_players(conn, round_date, map_name, round_num)
