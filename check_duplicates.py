...
cursor.execute('SELECT COUNT(*) FROM (SELECT DISTINCT session_id, player_guid FROM player_comprehensive_stats)')
...
if duplicates > 0:
    ...
    cursor.execute('''
        SELECT session_id, player_guid, player_name, COUNT(*) as count
