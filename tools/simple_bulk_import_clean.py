...
This is a cleaned, conflict-free implementation. Use this file instead of the broken
`tools/simple_bulk_import.py` until you want to replace it in-place.
"""
...
class SimpleBulkImporter:
    ...
    def __init__(self, db_path="bot/etlegacy_production.db", stats_dir="local_stats", file_patterns=None):
    ...
    def insert_player_stats(self, conn, session_id, session_date, result, player):
        ...
        # Normalize time_dead_ratio (parser may give fraction or percent)
