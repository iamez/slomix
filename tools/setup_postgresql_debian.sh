#!/bin/bash
# PostgreSQL Setup for Debian/Ubuntu (Database Server)
...
echo ""
echo -e "${BLUE}Step 3: Starting PostgreSQL service...${NC}"
...
echo ""
echo -e "${BLUE}Step 5: Configuring PostgreSQL for remote connections...${NC}"
...
if command -v ufw &> /dev/null; then
    ...
    echo -e "${YELLOW}⚠️  No firewall detected. Manually allow port 5432${NC}"
fi

echo ""
echo -e "${BLUE}Step 7: Restarting PostgreSQL...${NC}"
