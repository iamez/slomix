#!/bin/bash
# Bot Server Setup Script (Arch Linux / EndeavourOS)
...
pacman -S --noconfirm python python-pip git postgresql-libs

echo ""
echo -e "${BLUE}Step 3: Creating bot user...${NC}"
...
echo ""
echo -e "${BLUE}Step 4: Setting up bot directory...${NC}"
...
echo "   sudo -u etlegacy python -m venv $BOT_DIR/.venv"
echo ""
